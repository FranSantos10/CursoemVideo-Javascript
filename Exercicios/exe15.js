/**
 * 15) ​Um homem decidiu ir à uma revenda comprar um carro. Ele deseja comprar um carro hatch, e a revenda possui, além de carros hatch, sedans, motocicletas e caminhonetes. Utilizando uma estrutura switch, 
...
let modelo = 'hatch'
let mensagem = 'Tem certeza que não prefere este modelo?'

switch (modelo){
    case 'hatch': console.log('Compra efetuada com sucesso')
    break;
    case 'sedans': console.log(mensagem)
    break;
    case 'motocicletas': console.log(mensagem)
    break;
    case 'caminhonetes': console.log(mensagem)
    break;
